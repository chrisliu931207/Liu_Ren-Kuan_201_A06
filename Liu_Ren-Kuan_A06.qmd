...
print(sprintf("The maximum median annual temperature of %.2f occurred in %d and the minimum median annual temperature of %.2f occurred in %d.",max(median_temp),which.max(median_temp),min(median_temp),which.min(median_temp)))
```
